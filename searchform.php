...
?>
<form method="get" class="sc-searchform clearfix" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	...
	<input type="search" class="sc-searchform-field" name="s" id="sc-searchform-field-<?php echo isset( $sc_index ) ? absint( $sc_index ) : 0; ?>" value="<?php esc_attr_e( get_search_query() ); ?>" placeholder="<?php esc_attr_e( 'Search the Site&hellip;', 'scaffolding' ); ?>">
