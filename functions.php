...
function scaffolding_scripts_and_styles() {
	...
	wp_enqueue_style( 'scaffolding-fontawesome-all', get_stylesheet_directory_uri() . '/dist/css/libs/fontawesome/all.css', array(), '5.15.1' );
	...
	wp_enqueue_style( 'scaffolding-stylesheet', get_stylesheet_directory_uri() . '/dist/css/style.css', array(), $theme_css_version );
	...
	wp_enqueue_script( 'scaffolding-responsive-iframes', get_stylesheet_directory_uri() . '/dist/js/responsive-iframes.js', array( 'jquery' ), '1.0.0', true );
